...
def handle_snake():
    global body_coords
    global head_x, snake_dx
    global head_y, snake_dy
    global head_coord
...
def check_game_over():
    ...
    global running
    global is_paused
    if (head_rect.left < 0 or head_rect.right > WINDOW_WIDTH or head_rect.top < 0 or
            head_rect.bottom > WINDOW_HEIGHT or head_coord in body_coords):
